...
// 		$(".bbp-topic-form form textarea").cmt_mntn_mentions(
// 			cmt_mntn.mentions.users
// 		);
// 		$(".bbp-reply-form form textarea").cmt_mntn_mentions(
// 			cmt_mntn.mentions.users
// 		);
...
jQuery(function ($) {
	...
	function getUsernames(search, cb) {
		...
		xhr.open(
			"GET",
			Comment_Mention.ajaxurl + "?action=cmt_mntn_get_users&term=" + search,
			true
		);
